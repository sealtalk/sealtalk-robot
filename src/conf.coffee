module.exports =
  ...
  # 图灵颁发的 API Key，请访问图灵开发者平台：http://www.tuling123.com/html/doc/apikey.html
  TULING_API_KEY: '<-- 此处填写图灵颁发的 API Key -->'
  # 本服务部署的 HTTP 端口号
  SERVER_PORT: '8070'
  # MySQL 数据库名称
  DB_NAME: '<-- 此处设置数据库名称 -->'
  ...
  DB_PORT: '3306'
  # 机器人用户帐号 Id
  ROBOT_USER_ENCODED_ID: '<-- 此处设置机器人用户帐号 Id（加密 Id） -->'
  # 团队所在的群组 Id，机器人接受查询此群组中所有人的手机号信息
  TEAM_GROUP_ID: '<-- 此处设置团队所在群组在数据库中的 Id（未加密 Id） -->'
